...
export const lessons = [
...

  {
    ...
    activities: [],
    aiTeacherPrompt: {
      persona: "You are a helpful teacher.",
      lessonBrief: "Practice Daily Life.",
      audioInstructions: "Speak clearly.",
      correctionStyle: "Gentle corrections.",
      wrapUpPrompt: "End the lesson."
    }
  },
  {
    id: "spanish-lesson-4",
    ...
    aiTeacherPrompt: {
      persona: "You are a helpful teacher.",
      lessonBrief: "Practice Travel & Directions.",
      audioInstructions: "Speak clearly.",
      correctionStyle: "Gentle corrections.",
      wrapUpPrompt: "End the lesson."
    }
  ...
  },
  {
    ...
    aiTeacherPrompt: {
      persona: "You are a helpful teacher.",
      lessonBrief: "Practice Family & Friends.",
      audioInstructions: "Speak clearly.",
      correctionStyle: "Gentle corrections.",
      wrapUpPrompt: "End the lesson."
    }
  },
  {
    ...
    languageId: "es",
    title: "Hobbies",
    description: "Discuss what you like to do.",
    level: "beginner",
    mode: "practice",
    xpReward: 10,
    estimatedMinutes: 5,
